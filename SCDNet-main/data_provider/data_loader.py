...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        data_cols = cols + [self.target]
        df_raw[data_cols] = df_raw[data_cols].apply(pd.to_numeric, errors='coerce')
        df_raw[data_cols] = df_raw[data_cols].replace([np.inf, -np.inf], np.nan)
        if df_raw[data_cols].isna().values.any():
            df_raw[data_cols] = (
                df_raw[data_cols]
